...
FLAGS=-MT -WX -W4 -Wno-unused-parameter -Wno-unused-variable -GR -Oi -Zi
...
dll:
	@clang-cl $(FLAGS) src/ack.cc /LD /Fegame /link -incremental:no -opt:ref /EXPORT:GameUpdateAndRender 
